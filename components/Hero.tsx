      ...
      <div className="grid gap-16 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
        <div className="max-w-3xl" data-animate>
          ...
          <h1 className="text-5xl font-semibold leading-[0.9] tracking-[-0.04em] text-white sm:text-6xl lg:text-7xl [text-wrap:balance]">
            Build High-Performing Teams with Elite Global Talent
          </h1>

          <p className="mt-6 max-w-2xl text-lg leading-8 text-white/70 sm:text-xl">
            Hiring Rebels helps startups, enterprises, and global organizations hire exceptional talent through data-driven recruitment and human-first hiring strategies.
          </p>

          <div className="mt-10 flex flex-wrap gap-4">
            <a
              href="#contact"
              className="rounded-full bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-3 text-sm font-semibold text-white shadow-[0_14px_44px_rgba(37,99,235,0.35)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_18px_54px_rgba(37,99,235,0.45)]"
            >
              Book Discovery Call
            </a>
            <a
              href="#services"
              className="rounded-full border border-white/15 bg-white/[0.04] px-6 py-3 text-sm font-semibold text-white/85 transition duration-300 hover:-translate-y-1 hover:border-blue-400/40 hover:bg-white/[0.08]"
            >
              Explore Services
            </a>
          </div>
          ...
          <div className="mt-10 flex flex-wrap gap-3 text-sm text-white/60">
            <span className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-2 backdrop-blur-xl">
              ✓ 300+ leadership placements
            </span>
            <span className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-2 backdrop-blur-xl">
            ...
            <div className="relative overflow-hidden rounded-[28px] border border-blue-400/20 bg-gradient-to-br from-blue-600/20 via-blue-500/10 to-transparent p-6">
              ...
              <div className="relative z-10 flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-2 text-2xl font-semibold text-white">World Reach</p>
                </div>
                <div className="rounded-full border border-blue-400/30 bg-blue-600/20 px-3 py-2 text-sm font-medium text-blue-100">
                  Live
                </div>
              </div>
              ...
              <div className="relative mt-8 h-60 overflow-hidden rounded-[24px] border border-white/10 bg-[#05070b]/70 p-4">
                ...
                <div className="absolute left-[58%] top-[34%] h-3 w-3 rounded-full bg-cyan-200 shadow-[0_0_18px_rgba(125,211,252,0.95)]" />
                <div className="absolute left-[82%] top-[72%] h-3 w-3 rounded-full bg-blue-300 shadow-[0_0_18px_rgba(96,165,250,0.95)]" />
                <div className="absolute left-[24%] top-[58%] text-[10px] uppercase tracking-[0.3em] text-white/60">India</div>
                <div className="absolute left-[16%] top-[36%] text-[10px] uppercase tracking-[0.3em] text-white/60">USA</div>
                <div className="absolute left-[55%] top-[29%] text-[10px] uppercase tracking-[0.3em] text-white/60">UK</div>
                <div className="absolute left-[64%] top-[58%] text-[10px] uppercase tracking-[0.3em] text-white/60">UAE</div>
                <div className="absolute left-[58%] top-[34%] text-[10px] uppercase tracking-[0.3em] text-white/60">Germany</div>
                <div className="absolute left-[82%] top-[72%] text-[10px] uppercase tracking-[0.3em] text-white/60">Singapore</div>
              </div>
            </div>
          </div>
        </div>
